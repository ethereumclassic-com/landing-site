...
export default function MiningPoolsClient({
  livePools,
}: {
                  ...
                  <tr className="border-b border-[var(--border)]">
                    ...
                    >
                      <span className="inline-flex items-center gap-1">
                        Fee
                        {sortBy === 'fee' && (
                          <svg aria-hidden="true" className={`h-3 w-3 ${sortAsc ? '' : 'rotate-180'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
