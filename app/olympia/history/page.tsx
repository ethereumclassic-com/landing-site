...
const threads = [
  ...
  },
  {
    ...
    body: [
      'Ethereum Classic has been stewarded since 2016 by a global network of volunteer contributors — maintaining the chain, coordinating upgrades, and building the ecosystem before any formal organization existed. When ETCDEV collapsed, when ETC Labs wound down, when IOHK turned hostile, the chain did not stop. The contributors kept showing up. No single institution owns that continuity. It belongs to everyone who ran a node, reviewed an ECIP, maintained a client, built a tool, or held the line in a community forum when the narrative was against them. Two contributors who have been present since the beginning and who co-authored the Olympia ECIPs are worth naming — not as the full story, but as part of it.',
      'Cody Burns has been a founding contributor since 2016, serving as technical lead on every major network upgrade since inception. He wrote ECIP-1043 (Fixed DAG Limit, 2018), anticipating the GPU accessibility problem years before the 2020 attacks made it urgent. His foresight seeded Thanos (ECIP-1099, 2020): the ETChash transition that halved DAG growth, brought 3GB and 4GB GPUs back online, and positioned ETC to absorb Ethereum\'s displaced Ethash mining infrastructure when Ethereum merged to proof-of-stake in 2022. At the 2022 Mystique upgrade, Burns deliberately deferred EIP-1559. Not an omission — a deliberate design choice. The official network record is unambiguous: "The 2021 developer consensus landed on the treasury model, a position formalized four years later with the Olympia upgrade." Burns preserved the design space. When IOHK abandoned Mantis, Burns forked it under the name Fukuii — after Chordodes fukuii, a horsehair worm that hijacks a mantis and drives it toward water. The name is the story: Fukuii hijacks Mantis and drives it toward Olympia. Burns delivered on the 2018 Orbita Client vision ETCDEV had presented before their collapse: an ETC-native execution client with no upstream dependency on Ethereum\'s development cycle. He co-authored Olympia ECIPs 1111 through 1114.',
