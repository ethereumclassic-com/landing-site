              ...
              {troubleshootingTips.map((tip, index) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[var(--color-warning-bg)] text-[var(--color-warning)]">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          >
            <h2 className="text-xl font-bold text-[var(--text-primary)] md:text-2xl">
              Ready to use Ethereum Classic?
            </h2>
            <p className="mx-auto mt-3 max-w-lg text-[var(--color-text-secondary)]">
              Now that MetaMask is configured, connect it to an Ethereum Classic application to
              swap tokens, provide liquidity or track a portfolio.
            </p>
