    ...
    <main>
      ...
      <section className="hero-gradient-light noise-overlay grid-overlay relative overflow-hidden px-6 pt-24 pb-16 text-center md:px-10 md:pt-32 md:pb-24 lg:px-12">
        ...
        >
          ...
          >
            Choose a wallet that fits how you hold Ethereum Classic: hardware for long-term storage, browser and mobile wallets for everyday use.
          </p>
            ...
            return (
              ...
              >
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-bold text-[var(--text-primary)]">{category} Wallets</h3>
...
function CategoryIcon({ category }: { category: string }) {
  switch (category) {
    case 'Hardware':
      return (
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--color-warning-bg)] text-[var(--color-warning)]">
          <svg aria-hidden="true" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 3.75H6.912a2.25 2.25 0 00-2.15 1.588L2.35 13.177a2.25 2.25 0 00-.1.661V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18v-4.162c0-.224-.034-.447-.1-.661L19.24 5.338a2.25 2.25 0 00-2.15-1.588H15M2.25 13.5h3.86a2.25 2.25 0 012.012 1.244l.256.512a2.25 2.25 0 002.013 1.244h3.218a2.25 2.25 0 002.013-1.244l.256-.512a2.25 2.25 0 012.013-1.244h3.859M12 3v8.25m0 0l-3-3m3 3l3-3" />
          </svg>
        </div>
    ...
    case 'Browser':
      return (
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--color-info-bg)] text-[var(--color-info)]">
          <svg aria-hidden="true" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    case 'Mobile':
      return (
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--color-violet-bg)] text-[var(--color-violet)]">
          <svg aria-hidden="true" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    case 'Web':
      return (
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--color-success-bg)] text-[var(--color-success)]">
          <svg aria-hidden="true" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
