    ...
    >
      <div className="mb-4 flex items-center gap-3">
        {highlighted ? (
          ...
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--border-subtle)]">
...
export default function WhyFukuiiGui() {
  return (
      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          <h2 className="mt-4 text-2xl font-bold text-[var(--text-primary)] md:text-3xl">
            Basic Wallet vs Fukuii GUI Experience
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-[var(--color-text-secondary)]">
            See the difference between using a basic wallet alone versus enhancing it with Fukuii GUI
          </p>
        </motion.div>
        ...
        >
          <p className="mx-auto mb-6 max-w-xl text-[var(--color-text-secondary)]">
            Fukuii GUI enhances your wallet experience without replacing it.
            Use any wallet for key management, then connect to Fukuii GUI for advanced features.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="group inline-flex items-center justify-center gap-2 rounded-xl bg-[var(--color-primary)] px-6 py-3 font-medium text-[var(--brand-green-foreground)] transition-all hover:bg-[var(--color-primary-hover)] hover:shadow-lg hover:shadow-[var(--color-primary)]/25"
            >
              Launch Fukuii GUI
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--bg)] px-6 py-3 font-medium text-[var(--text-primary)] transition-all hover:border-[var(--color-primary)]/30 hover:bg-[var(--color-primary)]/10"
            >
              <svg aria-hidden="true" className="h-5 w-5 text-[var(--color-primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
