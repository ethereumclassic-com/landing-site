  ...
  return (
    ...
    >
      <div className="mb-4 flex items-start justify-between">
        <div>
          <h3 className="text-xl font-bold text-[var(--text-primary)]">{faucet.name}</h3>
          {faucet.notes && (
      ...
      <a
        ...
        className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[var(--color-primary)] px-6 py-3 font-medium text-[var(--brand-green-foreground)] transition-colors hover:bg-[var(--color-primary-hover)]"
      >
        Get Testnet ETC
    ...
    <main className="min-h-screen bg-[var(--bg)] pt-24 pb-16">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-[var(--text-primary)]">What is METC?</h3>
      ...
      <section className="px-6 pb-12 md:px-10 lg:px-12">
        <div className="mx-auto max-w-6xl">
          ...
          >
            <h2 className="mb-4 text-lg font-semibold text-[var(--text-primary)]">Mordor Testnet Configuration</h2>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-3">
                <div className="flex justify-between rounded-lg bg-[var(--bg)] p-3">
                  ...
                  <span className="font-mono text-sm text-[var(--text-primary)]">Mordor Testnet</span>
                </div>
                <div className="flex justify-between rounded-lg bg-[var(--bg)] p-3">
                  <span className="text-sm text-[var(--color-text-muted)]">Chain ID</span>
                  <span className="font-mono text-sm text-[var(--text-primary)]">63</span>
                </div>
                <div className="flex justify-between rounded-lg bg-[var(--bg)] p-3">
                  <span className="text-sm text-[var(--color-text-muted)]">Currency Symbol</span>
                  <span className="font-mono text-sm text-[var(--text-primary)]">METC</span>
                </div>
              </div>
              <div className="space-y-3">
            ...
            <div className="mt-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--bg)] px-4 py-2 text-sm font-medium text-[var(--text-primary)] transition-colors hover:bg-[var(--panel)]"
              >
      ...
      <section className="px-6 pb-12 md:px-10 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div
            className="rounded-xl border border-[var(--border)] bg-[var(--panel)] p-6"
          >
            <h2 className="mb-4 text-lg font-semibold text-[var(--text-primary)]">How to Use Testnet Faucets</h2>
            <div className="grid gap-4 md:grid-cols-3">
              <div className="rounded-lg bg-[var(--bg)] p-4">
                ...
                <h3 className="mb-2 font-medium text-[var(--text-primary)]">Add Mordor Network</h3>
              ...
              <div className="rounded-lg bg-[var(--bg)] p-4">
                ...
                <h3 className="mb-2 font-medium text-[var(--text-primary)]">Copy Your Address</h3>
                <p className="text-sm text-[var(--color-text-muted)]">
              ...
              <div className="rounded-lg bg-[var(--bg)] p-4">
                ...
                <h3 className="mb-2 font-medium text-[var(--text-primary)]">Request METC</h3>
                <p className="text-sm text-[var(--color-text-muted)]">
      ...
      <section className="px-6 md:px-10 lg:px-12">
        <div className="mx-auto max-w-6xl">
          ...
          >
            <h2 className="text-2xl font-bold text-[var(--text-primary)]">Ready to Deploy?</h2>
