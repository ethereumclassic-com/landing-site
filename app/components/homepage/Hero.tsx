  ...
  return (
    <section className="hero-gradient noise-overlay grid-overlay relative overflow-hidden px-6 py-24 md:px-10 md:py-32 lg:px-12 lg:py-40">
      <FadeIn className="relative mx-auto max-w-5xl">
        {/* Two-column layout on large screens: headline left, countdown right */}
        <div className="flex flex-col gap-12 lg:flex-row lg:items-center lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            {/* Subheading */}
            <p className="mt-6 max-w-2xl text-lg text-[var(--text-secondary)] md:text-xl lg:max-w-none">
            ...
            {/* Quick stats */}
            <div className="mt-10 flex flex-wrap items-center justify-center gap-8 lg:justify-start lg:gap-10">
              {[
