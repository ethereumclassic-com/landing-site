...
export const apps: App[] = [
  ...
  // Infrastructure
  {
    name: 'Fukuii',
    slug: 'fukuii',
    description: 'Multi-network Ethereum execution layer client in Scala 3. Native PoW for ETC and Mordor; Engine API for post-Merge Ethereum. The primary ETC client for the Olympia era.',
    longDescription: 'Fukuii is a multi-network Ethereum execution layer client built in Scala 3 by Chippr Robotics LLC. It provides native Proof-of-Work consensus for Ethereum Classic and Mordor, and pairs with any consensus client via Engine API V1–V4 for post-Merge Ethereum. One binary supports four networks: ETC mainnet, Mordor testnet, Sepolia, and ETH mainnet. The primary ETC client for the Olympia era, with SNAP sync, signed Docker images on GHCR, and JSON-RPC + MCP support.',
