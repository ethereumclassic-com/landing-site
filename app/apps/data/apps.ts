...
export const apps: App[] = [
  ...
  },
  {
    name: 'Core-Geth',
    slug: 'core-geth',
    description: 'A go-ethereum derivative maintained for Ethereum Classic, carried through the Olympia upgrade for network continuity.',
    longDescription: 'Core-Geth is a go-ethereum derivative maintained for Ethereum Classic — not a native ETC client, and not a plugin. It is the widely deployed Go client for the network, carried forward through the Olympia upgrade for network continuity while Fukuii takes the primary ETC client role. Upstream go-ethereum has deprecated Proof-of-Work support, so the upstream plugin architecture is the long-term path for Go-based ETC execution rather than a dedicated fork.',
    category: 'Infrastructure',
