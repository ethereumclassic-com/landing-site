...
import { cdcEntries, type CDCEntry } from '../data/index'
...
export default function CDCPostPage() {
  const params = useParams<{ slug: string }>()
  const entryIndex = cdcEntries.findIndex((e) => e.slug === params.slug)
    ...
    return (
      <main className="flex min-h-screen items-center justify-center px-6">
        <div className="text-center">
          ...
          <p className="mt-2 text-[var(--color-text-muted)]">This CDC entry doesn&apos;t exist.</p>
          <Link href="/core-devs" className="mt-4 inline-block text-sm text-[var(--color-primary)] hover:text-[var(--color-primary)]/80">
            ← Back to Archive
          </Link>
        </div>
      </main>
