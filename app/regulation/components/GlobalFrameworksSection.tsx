...
const regions = [
  {
    ...
    effective: 'Jul 2025 · Senate floor 2026',
    keyRules: [
      'Stablecoin reserves 1:1 liquid assets (GENIUS Act, signed Jul 18, 2025)',
      'SEC/CFTC jurisdictional perimeter clarified for digital commodities (CLARITY Act — Senate Banking passed May 2026; floor vote pending)',
  ...
  },
  {
    ...
    keyRules: [
      ...
      'ETC qualifies as a decentralized asset, exempt from ART/EMT issuer obligations',
  ...
  },
  {
    ...
    keyRules: [
      ...
      'Mexico: Fintech Law (Ley Fintech) 2018 with CNBV and Banxico joint oversight; ITFs authorized',
  ...
  },
  {
    ...
    keyRules: [
      ...
      'Norway: EEA/EFTA member. MiCA applies through the EEA agreement; Finanstilsynet oversight',
  ...
  },
  {
    ...
    keyRules: [
      'Russia: Digital Financial Assets (DFA) Law 2021. PoW mining is legal; using crypto for domestic payments is restricted; CBR oversight applies.',
      'China: Trading and mining banned since Sept 2021; PBOC developing e-CNY (digital yuan) as state-controlled alternative',
      'China: Hong Kong operates under a fully separate SFC licensing regime. Crypto trading is fully legal for licensed VASPs.',
