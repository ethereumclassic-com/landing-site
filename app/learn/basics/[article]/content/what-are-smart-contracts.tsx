...
export default function WhatAreSmartContracts() {
  return (
    <>
      ...
      <p>
        To interact with smart contracts on ETC, you&apos;ll need a wallet such as MetaMask connected to the Ethereum Classic network. From there, you can explore dApps, swap tokens on <ETCswapLink />, or even deploy your own contracts.
      </p>
    </>
  )
}
