...
export default function WhatIsEthereumClassic() {
  return (
    <>
      ...
      <h2>Why Proof-of-Work Matters</h2>
      <p>
        Proof-of-work provides several important benefits:
      </p>
      <ul>
        <li><strong>Security:</strong> Mining requires real-world resources, making attacks economically expensive</li>
        <li><strong>Decentralization:</strong> Anyone with hardware can participate in securing the network</li>
        <li><strong>Censorship Resistance:</strong> No central authority can prevent valid transactions</li>
        <li><strong>Fair Distribution:</strong> New coins are distributed to those who contribute computational work</li>
      </ul>

      <h2>The ETC Ecosystem</h2>
      <p>
      ...
      <h2>Getting Started with ETC</h2>
      <p>
        Ready to start using Ethereum Classic? Here&apos;s what you need to do:
      </p>
      <ol>
        <li><strong>Get a Wallet:</strong> Set up a non-custodial wallet such as MetaMask or a hardware wallet</li>
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <tbody>
            <tr>
              <td className="font-semibold">Consensus</td>
              <td>Proof-of-Work (ETChash)</td>
            </tr>
            <tr>
              <td className="font-semibold">Block Time</td>
              <td>~13 seconds</td>
            </tr>
            <tr>
              <td className="font-semibold">Max Supply</td>
              <td>~210.7 million ETC</td>
            </tr>
            <tr>
              <td className="font-semibold">Virtual Machine</td>
