export default function GettingStarted() {
  return (
    <>
      ...
      <p>
        The easiest method is to visit chainlist.org/chain/61 and click &ldquo;Connect Wallet&rdquo; to add ETC to MetaMask automatically.
      </p>
      ...
      <h2>Understanding ETC Basics</h2>
      ...
      <ul>
        <li>ETC Discord server</li>
        <li>Reddit: /r/ethereumclassic</li>
        <li>GitHub repositories</li>
        <li>Network monitors: etc-network.info</li>
      </ul>
