  ...
  return (
    ...
    >
      ...
      >
        ...
        <svg aria-hidden="true" className="h-5 w-5 text-[var(--color-text-muted)] transition-transform group-hover:translate-x-1 group-hover:text-[var(--color-primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <section className="border-t border-[var(--border)] px-6 py-16 md:px-10 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-[var(--text-primary)]">Research &amp; Data</h2>
              <p className="text-sm text-[var(--color-text-muted)]">In-depth data and analysis on the Ethereum Classic network</p>
            </div>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <p className="font-semibold text-[var(--text-primary)] group-hover:text-[var(--color-primary)]">Ethereum 2014 ICO</p>
              <p className="mt-1.5 text-sm text-[var(--color-text-muted)]">Presale data, ROI history, tokenomics, and how 72M ICO tokens became ETC&apos;s genesis supply.</p>
            </Link>
            <Link
              href="/research/emission-schedule"
              className="group rounded-xl border border-[var(--border)] bg-[var(--panel)] p-5 transition-colors hover:border-[var(--color-primary)]/30 hover:bg-[var(--color-primary)]/5"
            >
              <p className="font-semibold text-[var(--text-primary)] group-hover:text-[var(--color-primary)]">Emission Schedule</p>
              <p className="mt-1.5 text-sm text-[var(--color-text-muted)]">ECIP-1017 era charts, supply progression, and fifthing history.</p>
            </Link>
            <Link
          ...
          <div className="mt-4 text-right">
            <Link href="/research" className="text-sm text-[var(--color-primary)] hover:underline">
              All Research &amp; Data →
            </Link>
          </div>
        </div>
