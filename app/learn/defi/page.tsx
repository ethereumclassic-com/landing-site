        ...
        >
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-[var(--color-violet)] px-6 py-3 font-medium text-[var(--color-violet-foreground)] transition-all hover:bg-[var(--color-violet)]"
            >
              Launch ETCswap
              <svg aria-hidden="true" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
