...
export default function LiquidityPools() {
  return (
    <>
      <p>
        Liquidity pools are the engine behind decentralized exchanges. Instead of matching individual buyers with sellers through an order book, AMMs like <ETCswapLink /> use pools of tokens that anyone can trade against. Understanding how pools work is essential before providing liquidity.
      </p>

      <h2>What Is a Liquidity Pool?</h2>
      <p>
        A liquidity pool is a smart contract holding reserves of two tokens. For example, an ETC/USC pool contains both ETC and <ClassicUSDLink />. When a trader swaps ETC for USC, they deposit ETC into the pool and withdraw USC from it. The pool&apos;s smart contract handles the exchange automatically.
      </p>
      <p>
      ...
      <p>
        <ETCswapLink /> V2 uses the constant product formula: <strong>x * y = k</strong>, where x and y are the reserves of each token and k is a constant. When a trader buys token A, the amount of token A in the pool decreases and token B increases, pushing the price of A higher.
      </p>
      <p>
      ...
      <p>
        Every swap on <ETCswapLink /> incurs a small trading fee (typically 0.3% on V2). This fee is added to the pool&apos;s reserves, increasing the value of all LP tokens proportionally. As a liquidity provider, you earn a share of every trade that passes through your pool.
      </p>
      <p>
      ...
      <h2><ETCswapLink /> V2 vs V3 Liquidity</h2>

      <h3>V2: Full-Range Liquidity</h3>
      <p>
        In <ETCswapLink /> V2, your liquidity is spread across the entire price range from zero to infinity. You deposit equal value of both tokens. This is simpler to manage but less capital-efficient&mdash;most of your liquidity sits in price ranges where trading never occurs.
      </p>

      <h3>V3: Concentrated Liquidity</h3>
      <p>
        <ETCswapLink /> V3 lets you concentrate your liquidity within a specific price range. For example, if ETC is trading at $20, you might provide liquidity only between $15 and $25. This means your capital works harder within that range, earning more fees per dollar deposited.
      </p>
      <p>
      ...
      <p>
        To provide liquidity on <ETCswapLink />, you need equal value of both tokens in the pair. Connect your wallet, navigate to the pool you want to join, and approve the deposit. Our step-by-step <ETCswapLink /> guide walks through the full process.
      </p>
    </>
  )
}
