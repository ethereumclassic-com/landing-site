      ...
      <section className="border-b border-[var(--border)] bg-[var(--panel)] px-6 py-16 md:px-10 lg:px-12">
        <div className="mx-auto max-w-4xl">
          ...
          >
            ...
            <Link
              href="/learn/on-ramp"
              className="inline-flex items-center gap-2 rounded-xl border border-amber-500/30 bg-amber-500/10 px-5 py-2.5 font-medium text-amber-400 transition-all hover:bg-amber-500/20"
            >
              Full On-Ramp Guide
              <svg aria-hidden="true" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
