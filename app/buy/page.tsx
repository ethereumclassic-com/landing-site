...
export default function BuyPage() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Transfer ETC to your personal wallet or use Fukuii GUI to manage capital flows.',
      icon: <WalletIcon />,
    },
  ]
    ...
    <main>
      ...
      <section className="hero-gradient-light noise-overlay grid-overlay relative overflow-hidden px-6 pt-24 pb-16 text-center md:px-10 md:pt-32 md:pb-24 lg:px-12">
        ...
        >
          ...
          >
            Acquire Ethereum Classic through major centralized exchanges, DEX trading on ETCswap, or peer-to-peer markets. Payment options range from card and bank transfer to crypto-to-crypto swaps, with coverage in most countries worldwide.
          </p>
      ...
      <section className="border-b border-[var(--border)] bg-[var(--panel)] px-6 py-16 md:px-10 lg:px-12">
        <div className="mx-auto max-w-4xl">
          ...
          >
            ...
            <Link
              href="/learn/on-ramp"
              className="inline-flex items-center gap-2 rounded-xl border border-[var(--color-warning-border)] bg-[var(--color-warning-bg)] px-5 py-2.5 font-medium text-[var(--color-warning)] transition-all hover:bg-[var(--color-warning)]/20"
            >
              Full On-Ramp Guide
              <svg aria-hidden="true" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      {/* Major Exchanges */}
      <section id="exchanges" className="px-6 pt-24 pb-16 md:px-10 md:pt-32 md:pb-24 lg:px-12">
        <div className="mx-auto max-w-6xl">
          ...
          >
            <Link
              href="/buy/exchanges"
              className="inline-flex items-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--panel)] px-6 py-3 font-medium text-[var(--text-primary)] transition-all hover:border-[var(--color-primary)]/30 hover:bg-[var(--color-primary)]/10"
            >
      ...
      <section className="border-t border-[var(--border)] bg-[var(--panel)] px-6 py-16 md:px-10 lg:px-12">
        <div className="mx-auto max-w-4xl">
          <div
            className="rounded-2xl border border-[var(--color-warning)]/20 bg-[var(--color-warning)]/5 p-6"
          >
