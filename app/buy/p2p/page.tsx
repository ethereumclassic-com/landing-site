    ...
    >
      ...
      <div className="mb-4 grid grid-cols-2 gap-4 text-sm">
        <div>
          ...
          <p className="font-medium text-[var(--text-primary)]">{escrowType}</p>
        </div>
        <div>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          >
            <div className="mb-6 flex items-center gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--color-warning-bg)]">
              ...
              <h3 className="text-xl font-bold text-[var(--text-primary)]">P2P Safety Tips</h3>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-medium text-[var(--text-primary)]">Use Escrow</h4>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-medium text-[var(--text-primary)]">Check Reputation</h4>
                  <p className="text-sm text-[var(--color-text-muted)]">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-medium text-[var(--text-primary)]">Never Release Early</h4>
                  <p className="text-sm text-[var(--color-text-muted)]">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-medium text-[var(--text-primary)]">Keep Records</h4>
                  <p className="text-sm text-[var(--color-text-muted)]">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-medium text-[var(--text-primary)]">Use Platform Chat</h4>
                  <p className="text-sm text-[var(--color-text-muted)]">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-medium text-[var(--text-primary)]">Start Small</h4>
                  <p className="text-sm text-[var(--color-text-muted)]">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <Link
                href="/buy/instant"
                className="inline-flex items-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--bg)] px-6 py-3 font-medium text-[var(--text-primary)] transition-all hover:border-[var(--color-primary)]/30 hover:bg-[var(--color-primary)]/10"
              >
                <svg aria-hidden="true" className="h-5 w-5 text-[var(--color-primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
                </svg>
